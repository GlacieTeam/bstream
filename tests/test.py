...
def test1() -> None:
    ...
    print(f"hex: {hex}")
    print(
        f"compare: {hex == '010203000400000005000000000000000100000000000018400000e0400800000009000000000000000a000b0c1a1c808080801000000010023137120000'}"
    )


def test2() -> None:
    buffer = bytearray.fromhex(
        "010203000400000005000000000000000100000000000018400000e0400800000009000000000000000a000b0c1a1c808080801000000010023137120000"
    )
